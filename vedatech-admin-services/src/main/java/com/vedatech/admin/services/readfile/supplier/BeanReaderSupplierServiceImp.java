...
public class BeanReaderSupplierServiceImp implements BeanReaderSupplierService {
    ...
    @Override
    public List<Supplier> readWithCsvBeanReaderSupplier(Supplier supplier, String file) throws IOException {
        ...
        try {
            ...
            suppliers = beanReaderService.BeanReaderSave(Supplier.class, beanReader,processors,header);
